...
try:
    ...
    FFMPEG = config("FFMPEG",'ffmpeg -i "{}" -preset slower -crf 24 -tune animation -c:v libx265 -s 1920x1080 -colorspace bt2020nc -color_trc smpte2084 -color_primaries bt2020 -c:a libopus -b:a 32k -vbr on -compression_level 10 -ac 2 "{}"')
